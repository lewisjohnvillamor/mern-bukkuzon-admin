  ...
  return (
    <div className="product">
      <div className="productTitleContainer">
        ...
        <Link to="/newproductbacth">
          <button className="productAddButton">Create by Batch</button>
        </Link>
      </div>
      ...
      <div className="productBottom">
        <form className="productForm">
          <div className="productFormLeft">
            ...
            <label>Stock</label>
            <input type="stock" placeholder={product.stock} onChange={handleChange} />

            <div className="addProductItem">
            <label>Categories</label>
            <input type="text" placeholder="manga" onChange={handleCat} />
        </div>
          </div>
